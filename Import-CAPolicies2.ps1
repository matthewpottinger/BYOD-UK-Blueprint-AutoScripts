...
$ImportPath = "C:\Users\mapottin\Documents\GitHub\Intune\CA JN\Import"
...
$JSON_Convert.conditions.users.includeGroups = @($AllowTargetGroupId)

$JSON_Convert.conditions.users.excludeGroups = @($ExcludeTargetGroupId)
